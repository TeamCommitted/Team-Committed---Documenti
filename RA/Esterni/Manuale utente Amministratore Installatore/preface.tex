...
\newcommand{\doctitle}{Manuale Utente - Amm. Installatore }
...
\newcommand{\verificatori}{Marco Begolo}
...
\newcommand{\testosommario}{Il seguente documento ha lo scopo di illustrare quali operazioni dovr\'a eseguire un Amministratore Installatore per installare correttamente il \nameproject all'interno di un'azienda}
