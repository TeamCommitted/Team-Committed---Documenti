...
\newcommand{\testosommario}{Il seguente documento ha lo scopo di illustrare quali operazioni dovrà eseguire un Amministratore Installatore per installare correttamente il \nameproject all'interno di un'azienda}
