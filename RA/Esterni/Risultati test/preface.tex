...
\newcommand{\doctitle}{Risultati dei Test}
...
\newcommand{\testosommario}{Questo documento vuol elencare i risultati dei test che \TeamCommitted ha eseguito.}
