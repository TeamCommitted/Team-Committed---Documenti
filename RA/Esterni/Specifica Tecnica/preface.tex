...
\item \TeamCommitted
\item \emph{Prof. Riccardo Cardin}
\end{itemize}}

%%INSERIRE IL SOMMARIO DEL DOCUMENTO
\newcommand{\testosommario}{Questo documento vuol definire l'architettura generale che il prodotto dovr\`a avere.}
