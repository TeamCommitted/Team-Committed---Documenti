...
\newcommand{\doctitle}{Guida alla Gamification del \nameproject }
...
\newcommand{\testosommario}{Questo documento vuole sia descrivere l'idea che il \TeamCommitted si è fatta della Gamification, sia mostrare come verrà applicata all'interno del \nameproject , sia come potrà essere applicata in un futuro al sistema.}
